...
& git -C $root archive --format=zip --prefix=ComfyUI-ComfyRemote/ -o $archive HEAD __init__.py comfyremote_connector web requirements.txt pyproject.toml README.md LICENSE CHANGELOG.md docs/privacy.md docs/server-setup.md docs/hosted-beta.md docs/release-0.2.0.md docs/workflow-controls.md docs/workflow-updates.md
